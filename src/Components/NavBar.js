...
const NavBar = () => {
    return (
        <div style={{ marginBottom: "57px" }}>
            <nav className="navbar navbar-expand-lg  navbar-light fixed-top" style={{ background: "darkgreen" }}>
                <div className="container-fluid container">
                    ...
                    <div className="navbar-nav font-weight-bold ms-auto ">
                        ...
                        <Link className="nav-link px-3 text-white fw-bold" to="/contact">Contacts</Link>
